...
<script> // menangani SEARCHING
    $(function () {
        // Mengambil elemen dengan id 'search'
        $('#search').on('keyup', function () {
            var query = $(this).val(); // Mengambil nilai dari input pencarian
            console.log(query); // Mencetak nilai query ke konsol untuk debugging

            //Mengirim permintaan AJAX ke server
            $.ajax({
                url: "{{ route('postsSearch') }}", //URL tujuan permintaan AJAX
    ...
    $(document).ready(function () {
        ...
        $('.status-toggle').change(function () { // Publis Unpublis
